<recipetype:tconstruct:melting>.addOreMeltingRecipe("uncommon_simple", <item:contenttweaker:uncommon_cluster>, <fluid:tconstruct:molten_iron>*8, 1, 10, [<fluid:tconstruct:molten_aluminum>*16, <fluid:tconstruct:molten_bronze>*32, <fluid:thermal:redstone>*16]);
