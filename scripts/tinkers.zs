...
<recipetype:tconstruct:casting_table>.addItemCastingRecipe("item_casting_table_coal_sand", <tag:items:tconstruct:casts/single_use/gem>, <fluid:contenttweaker:molten_coal> * 144, <item:minecraft:coal>, 100, false, true);
<recipetype:tconstruct:melting>.addOreMeltingRecipe("coal", <item:minecraft:coal_ore>, <fluid:contenttweaker:molten_coal>*288, 1, 10, [<fluid:contenttweaker:liquid_cobblestone>*1000]);
