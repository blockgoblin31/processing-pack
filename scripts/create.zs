...
<recipetype:create:sequenced_assembly>.addRecipe(<recipetype:create:sequenced_assembly>.builder("hot_stick").require(<item:contenttweaker:extinguished_stick>).transitionTo(<item:contenttweaker:fire_stick>).loops(16).addOutput(<item:contenttweaker:graphite_lollipop>, 1).addStep(<recipetype:create:pressing>.factory(), (rb) => rb.require(<item:mekanism:dust_coal>)));
...
<recipetype:create:crushing>.addRecipe("gunpowder1", [<item:minecraft:gunpowder> % 65], <item:minecraft:flint>);
...
<recipetype:create:milling>.removeRecipe(<item:create:cinder_flour>);
