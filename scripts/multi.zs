...
//item outputs.
val crushed = [<item:contenttweaker:core_ingot> * 2, <item:minecraft:glowstone_dust> * 2, <item:thermal:lapis_dust> * 2, <item:appliedenergistics2:certus_quartz_dust> * 2, <item:mekanism:dust_coal> * 2, <item:exnihilosequentia:dust>, <item:contenttweaker:verdentium_grit>, <item:contenttweaker:verdentium_grit>, <item:contenttweaker:slag_dust>, <item:contenttweaker:purer_powder>, <item:contenttweaker:pure_terrestrial_sawdust>, <item:contenttweaker:pure_infernal_sawdust>, <item:contenttweaker:pure_voidic_sawdust>, <item:contenttweaker:zinc_dust>, <item:contenttweaker:core_dust>, <item:contenttweaker:pure_powder>, <item:contenttweaker:epic_powder>] as IItemStack[];
//machines
